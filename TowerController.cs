...
yield return new  WaitForSecondsRealtime(0.5f);
 ...
 Controller.RB.velocity = new Vector3(0, 0,0);
            ...
            FreezeBoxesGameOver();
                ...
                //show interstitielHere 
                Camera.main.GetComponent<SdkInitialization>().ShowInterstitielAds();
        ...
        Vector3 input = new Vector3(Controller.RB.velocity.x, 0f, 0f) * Time.fixedDeltaTime;
 ...
 instability *=iFac*0.25f;
      ...
      //  instability = Vector3.Angle(dir.normalized, Vector3.up) / breakAngles.Evaluate(idx);
        ...
        if (update) {
            ...
            obj.velocity = (vel * forceScale + yVel + zVel + wind) / Time.fixedDeltaTime;
